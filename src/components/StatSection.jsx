...
const StatSection = () => {
    return (
        <div className='w-full md:max-w-6xl mx-auto pt-12 md:pt-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-4 md:space-y-10 md:px-20 lg:px-0 justify-items-center'>
                <div className='shadow-md shadow-fuchsia-500 p-5 w-60 h-45 rounded-xl text-center'>
