...
export default function Banner() {
  return (
    <div className="max-w-full mx-auto overflow-hidden bg-[url('/assets/banner.png')] bg-cover bg-center md:bg-auto overflow-hidden md:bg-left-top bg-no-repeat">
      <div className="relative w-full md:max-w-full h-100 md:h-185">
        <div className="absolute left-5 top-5 md:left-30 md:top-15 z-12 md:text-center">
          <div className="text-blue-800 md:px-10 md:py-20 rounded-2xl">
